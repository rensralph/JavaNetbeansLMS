...
public class AllBooks extends javax.swing.JFrame {
    ...
    public void Update() {
        String sql = "UPDATE `books` SET `book_id`= ?,`name`= ?,`publisher`= ?,`edition`= ?,`author`= ? WHERE `book_id`= ?";
        try {
    ...
    public void DeleteReturn() {
        String sql = "DELETE FROM `return_book` WHERE book_id = ?";
        try {
            pst = conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            pst.execute();
    ...
    public void jTable1() {
        String sql = "select book_id AS Book_ID, name AS Book_Name, publisher AS Publisher, edition AS Edition, author AS Author_Name from books where book_id order by name";
        try {
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 159, 28), 2, true), "All Books", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 18), new java.awt.Color(255, 159, 28))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jComboBox2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
